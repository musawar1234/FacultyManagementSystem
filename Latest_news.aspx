<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Latest_news.aspx.cs" Inherits="WebApplication_EntryForm.Latest_news" %>
...
<asp:GridView ID="gvHeadsOfDept" runat="server"
    ...
    AllowPaging="true"
    PageSize="12"
    OnPageIndexChanging="gvHeadsOfDept_PageIndexChanging"
    EmptyDataText="No Heads of Departments found.">
